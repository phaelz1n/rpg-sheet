export const DEFAULT_ITEMS = [
  ...
  { name: 'Roupa de Couro Leve', type: 'chest', rarity: 'common', description: 'Proteção básica e leve para o corpo.' },
  { name: 'Ataduras de Punho', type: 'gloves', rarity: 'common', description: 'Envoltórios para as mãos.' },
  { name: 'Botas Rústicas', type: 'boots', rarity: 'common', description: 'Calçado resistente para longas jornadas.' },
  { name: 'Kimono de Pano', type: 'chest', rarity: 'common', description: 'Vestimenta leve e flexível.' },
  { name: 'Calça de Pano', type: 'pants', rarity: 'common', description: 'Vestimenta básica para as pernas.' },
  { name: 'Botas de Couro', type: 'boots', rarity: 'common', description: 'Calçado de couro curtido.' },
  { name: 'Bandana de Combate', type: 'head', rarity: 'common', description: 'Acessório simples para a cabeça.' },
  { name: 'Faixas Vermelhas', type: 'gloves', rarity: 'common', description: 'Envoltórios para os braços.' },
  ...
  { name: 'Medalhão Sussurrante', type: 'neck', rarity: 'legendary', description: 'Relíquia misteriosa concedida por uma mãe.' },
  { name: 'Pele de Urso', type: 'chest', rarity: 'rare', description: 'Manto pesado que oferece 3 de #rd.' },
  { name: 'Amuleto Tosco', type: 'neck', rarity: 'rare', bonus: 1, description: 'Concede +1 em testes de #intimidação.' },
  { name: 'Coroa de Ossos', type: 'head', rarity: 'rare', corruptionLimitBonus: 1, description: 'Artefato macabro que expande o limite de #corrupção em +1.' },
  { name: 'Foco de Fé', type: 'neck', rarity: 'rare', statBonus: '+1 #fé', description: 'Canalizador espiritual para ritos sagrados. Concede +1 em #fé.' },
  ...
  { name: 'Extração do Terno da "Chama" :: A.B.S', type: 'chest', rarity: 'rare', description: 'Armadura média imbuída de essência ígnea.' },
  { name: 'Coldre de Couro Simples', type: 'belt', rarity: 'common', description: 'Acesso rápido: 1 slot.', beltCapacity: 1 },
  { name: 'Cinto de Utilidade do Explorador', type: 'belt', rarity: 'rare', description: 'Acesso rápido: 2 slots.', beltCapacity: 2 },
  { name: 'Cinto de Arsenal Real', type: 'belt', rarity: 'legendary', description: 'Acesso rápido: 4 slots.', bonus: 1, beltCapacity: 4 }
];
