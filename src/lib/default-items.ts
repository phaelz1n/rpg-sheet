export const DEFAULT_ITEMS = [
  ...
  { name: 'Medalhão Sussurrante', type: 'armor', equipmentSlot: 'neck', rarity: 'legendary', description: 'Relíquia misteriosa concedida por uma mãe.' },
  ...
  { name: 'Extração do Terno da "Chama" :: A.B.S', type: 'armor', equipmentSlot: 'chest', rarity: 'rare', description: 'Armadura média imbuída de essência ígnea.' },
  ...
  { name: 'Cinto de Arsenal Real', type: 'armor', equipmentSlot: 'belt', rarity: 'legendary', description: 'Acesso rápido: 4 slots.', bonus: 1, beltCapacity: 4 }
];
