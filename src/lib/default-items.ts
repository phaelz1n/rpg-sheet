export const DEFAULT_ITEMS = [
  ...
  { name: 'Argilita Sombria', type: 'material', rarity: 'common', description: 'Argila escura imbuída de leves traços de energia espiritual.', particles: 'void' },
  ...
  { name: 'Sílex Rachado', type: 'material', rarity: 'common', description: 'Pedra afiada usada para criar faíscas e armas rudimentares.', particles: 'sparks' },
  ...
  // <--- MINÉRIOS RAROS (10) --->
  { name: 'Sangrita', type: 'material', rarity: 'rare', description: 'Cristal avermelhado que pulsa como um coração. Rituais.', particles: 'embers' },
  ...
  { name: 'Olho de Ébano', type: 'material', rarity: 'rare', description: 'Gema negra profunda usada em rituais de visão.', particles: 'void' },
  { name: 'Lágrima do Véu', type: 'material', rarity: 'rare', description: 'Substância semi-líquida usada para encantar armas.', particles: 'frost' },
  ...
  { name: 'Necronita', type: 'material', rarity: 'rare', description: 'Metal que drena a vitalidade. Armas/Rituais.', particles: 'void' },
  ...
  { name: 'Foco de Fé', type: 'armor', equipmentSlot: 'neck', rarity: 'rare', statBonus: '+1 #fé', description: 'Canalizador espiritual para ritos sagrados. Concede +1 em #fé.', particles: 'gold_dust' },
