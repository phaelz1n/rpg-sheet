      ...
      <AnimatePresence mode="wait">
        {!isEmpty ? (
          ...
          >
            ...
            <div className="relative w-full h-12 sm:h-16 flex-shrink-0 flex items-center justify-center my-1 rounded bg-black/20 border border-white/5 group/img overflow-hidden">
              {imageUrl ? (
